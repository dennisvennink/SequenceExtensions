  ...
  class Convolution4Tests: XCTestCase {
    ...
    func testShouldReturnValidResults () {
      self.validate(Array(convolution([1, 2], [3, 4], [5, 6], [Int]())), against: [(Int, Int, Int, Int)]())
      self.validate(Array(convolution([1, 2], [3, 4], [5, 6], [7, 8, 9])), against: [(1, 3, 5, 7), (2, 4, 6, 8)])
      self.validate(Array(convolution([1, 2], [3, 4], [5, 6], [7, 8])), against: [(1, 3, 5, 7), (2, 4, 6, 8)])
    }

    func testResultsShouldBeLazyEvaluated () {
      iterationCount = 0

      _ = convolution([1, 2], [3, 4], [5, 6], [7, 8])
